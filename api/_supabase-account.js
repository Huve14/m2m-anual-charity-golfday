...
function buildRegistrationRow(details, userContext, registrationRecord = null) {
  ...
  return {
    ...
    privacy_notice_version: details.privacyNoticeVersion || null,
    registration_consent: details.registrationConsent === true,
    player_data_consent: details.playerDataConsent === true,
    marketing_consent: details.marketingConsent === true,
    consented_at: details.consentedAt || null,
    consent_source: "website",
    consent_tags: Array.isArray(details.consentTags) ? details.consentTags : [],
