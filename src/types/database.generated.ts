...
export type Database = {
  public: {
    Tables: {
      ...
      m2m_event_companies: Table<IdDates & EventOwned & { company_id: string; relationship_status: "prospect" | "pending" | "confirmed" | "cancelled"; primary_contact_name: string | null; primary_contact_email: string | null; primary_contact_phone: string | null; notes: string | null }>;
      ...
      m2m_fourballs: Table<IdDates & EventOwned & { event_company_id: string; team_name: string; booking_status: "pending" | "confirmed" | "cancelled"; confirmed_amount_minor: number; invoice_reference: string | null; payment_status: "unpaid" | "partial" | "paid" | "waived"; submission_status: "draft" | "submitted" | "reopened"; submitted_at: string | null; submitted_by: string | null; consent_version: string | null; consented_at: string | null; notes: string | null }>;
