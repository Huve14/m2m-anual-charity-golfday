...
- When the task is complete, ensure the project is scaffolded, compiled, documented, and launchable.
- README.md should exist and be up to date.
- User should be able to debug or launch the project from VS Code.
